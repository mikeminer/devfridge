...
import { SHOWCASE_STATUS } from '@/lib/game-builder-prompts';
...
export default function HackathonLayout({ children }: { children: React.ReactNode }) {
  return <div className={s.site}>
    ...
    <header className={s.header}>
      ...
      <nav aria-label="Main navigation"><a href="/hackathon/handbook/start">Handbook</a><a href="/hackathon#submit">Submit with your agent</a><a href="/projects" className={s.projectsNav}>Projects</a><a className={s.navCta} href={SKILL_URL}>Get the skill ↗</a></nav>
    </header>
    {children}
    <footer className={s.footer}><div><a className={s.brand} href="/hackathon">DEVFRIDGE / HACKATHON</a><p>Built for communities that want something to play.</p><small>A DevFridge initiative. No announced sponsorship by Solana, Pump.fun or Phantom.</small></div><div><a href="/hackathon/handbook/rules">Rules & conduct</a><a href="/hackathon/handbook/faq">FAQ</a><a href="https://connect.devfridge.cool">Official contacts ↗</a><a href="/hackathon/llms.txt">For AI agents ↗</a></div><p className={s.footerStatus}>{SHOWCASE_STATUS}</p></footer>
  </div>;
}
