...
export const metadata: Metadata = {
  ...
  description:
    "Canonical LayerZero OFT routes between Robinhood Chain and Solana, protected by rate limits, multisig governance and emergency pause.",
  alternates: { canonical: "https://bridge.devfridge.cool" },
  openGraph: {
    type: "website",
    url: "https://bridge.devfridge.cool",
    title: "DevFridge Bridge",
    description: "Canonical token routes with rate limits, multisig governance and emergency pause.",
