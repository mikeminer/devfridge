...
Keep an AI build log and prepare the submission template. Hackathon dates, prizes and the submission window are still to be announced.`;
...
export const CHAPTERS: Chapter[] = [
  { slug: 'start', title: 'Start here', intro: 'One meme. One playable world. Build with your coding agent and the DevFridge stack.', sections: [
    ...
    { title: 'Event status', paragraphs: ['The preparation kit is available now. Event dates, submission opening and deadline, judges, awards and prizes are to be announced. This site does not yet accept entries or register participants. Starting a project now does not reserve a place or guarantee eligibility for future prizes.', 'There is no hackathon entry fee announced. The skill download is free. AI tools, hosting, RPC usage, Solana network fees and optional token activity can have separate costs. Recheck the published rules when submissions open.'] },
  ...
  { slug: 'rules', title: 'Participation & conduct', intro: 'Build in public with care. Make the work reviewable and the experience welcoming.', sections: [
    { title: 'Preparation rules', paragraphs: ['This is the initial preparation handbook. Dates, submission channel, judges, final eligibility and any prize-specific terms will be published before entries open. No prize, grant, token allocation or acceptance is promised by this page.', 'Solo builders and teams may prepare projects now. Disclose pre-existing code, templates and earlier game versions so reviewers can understand what you added. AI assistance is encouraged; identify the tools and review the output yourself.'] },
  ...
  { slug: 'submission', title: 'Prepare your submission', intro: 'Make it easy for someone else to play, inspect and reproduce your game.', sections: [
    { title: 'Submission status', paragraphs: ['The submission window and destination are to be announced. Downloading a template, copying a prompt or sharing a build is not an official entry. Prepare the following package now; this page will identify the submission channel when it opens.'] },
  ...
  ], links: [['Download submission template', '/kit/submission.md'], ['Download AI build log', '/kit/build-log.md'], ['Download review scorecard', '/kit/scorecard.md']] },
  { slug: 'faq', title: 'Frequently asked questions', intro: 'The practical answers before you start building.', sections: [
    ...
    { title: 'Where do I register? What are the dates and prizes?', paragraphs: ['They are to be announced. There is no registration or submission form yet. Use this site to prepare and return for official event details. Organizer contacts are listed in the DevFridge directory.'] },
...
Status: Preparation only. Submission destination and dates to be announced.
