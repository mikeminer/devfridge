...
export const CHAPTERS: Chapter[] = [
  ...
  { slug: 'submission', title: 'Submit with your agent', intro: 'Make it easy for someone else to play, inspect and reproduce your game.', sections: [
    ...
    { title: 'Review and publication', paragraphs: ['The submission target is mikeminer/devfridge, branch master. Each game adds one metadata file at scan/data/hackathon-projects/<slug>.json. Its source and playable demo stay in your own repository and hosting. Your agent follows the repository template and validates the file before opening a PR.', 'The owner reviews the game, evidence and ownership. After review, the maintainer copies the approved release into scan/data/projects.json. Only entries marked approved and published appear in the gallery and public /projects.json feed after a successful production deployment. Approval alone is not publication: merge and deployment must succeed. Your agent reports the real PR link and status. Dates, prizes and final competition eligibility remain to be announced; a listing is not a prize or an audit.'] },
...
Your agent creates scan/data/hackathon-projects/<slug>.json from the repository template, validates it and opens the PR. Owner review + scan/data/projects.json release update + merge + successful deployment publish the card and /projects.json feed.
